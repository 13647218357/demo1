...
autoPlayMusic();
        ...
        $(document).ready(function () {
            $('#fullpage').fullpage({
                ...
                anchors: ['firstPage', 'secondPage', '3rdPage', '4thpage', '5thpage', '6thpage', '7thpage', '8thpage', '9thpage', 'tenthpage', 'eleventhpage','12thpage'],
                //menu: '#menu',//文字导航
                ...
                onLeave: function onLeave(index, nextIndex, direction) {
                    ...
                    if (index == 1) {
						...
						$('#class2').hide().removeClass('element-box');
						$('#class3').hide().removeClass('element-box');
						$('.class4').hide().removeClass('element-box');
						$('.class5').hide().removeClass('element-box');
						//$('#inside_8574368454').hide().removeClass('element-box');
                        ...
                        //顶部花
						$('#edit_area711062').hide().removeClass('element-box');
                        ...
                        //顶部花
						$('#edit_area799057').hide().removeClass('element-box');
						//$('.ee').find('img').hide().removeClass('dong');
                        ...
                        //底部花加载
						$('.npage4_b').find('img').hide().removeClass('dong');
						$('.npage5_b').find('img').hide().removeClass('dong');
                        $('.js_page4_b').find('img').hide().removeClass('dong');
                    } else if (index == 4) {
                        //顶部花
						
						$('#edit_area799059').hide().removeClass('element-box');
                        ...
                        //顶部花
						$('#edit_area28759').hide().removeClass('element-box');
                        ...
                        //顶部花
						$('#edit_area287590').hide().removeClass('element-box');
                        ...
                        //顶部花
						$('#edit_area2875909').hide().removeClass('element-box');
                        ...
                        //顶部花
						$('#edit_area2875909ac').hide().removeClass('element-box');
                        ...
                        //顶部花加载
						$('#edit_area267571').hide().removeClass('element-box');
                        ...
                        //顶部花加载 
						$('#edit_area2675712a').hide().removeClass('element-box');
                        ...
                        //顶部花
						$('#edit_area2675712bb').hide().removeClass('element-box');
                ...
                afterLoad: function afterLoad(anchorLink, index) {
                    ...
                    if (index == 1) {
						...
						$('#class2').show().addClass('element-box');
						$('#class3').show().addClass('element-box');
						$('.class4').show().addClass('element-box');
						$('.class5').show().addClass('element-box');
                        //$('#inside_8574368454').show().addClass('element-box');
                        ...
                        //顶部花
						$('#edit_area711062').show().addClass('element-box');
                        ...
                        //顶部花
						$('#edit_area799057').show().addClass('element-box');
						//$('.ee').find('.img').show().addClass('dong');
                        ...
                        //底部花加载
						$('.npage4_b').find('img').show().addClass('dong');
						$('.npage5_b').find('img').show().addClass('dong');
                        setTimeout(function () {
                            $('.js_page3_b').find('img').show().addClass('dong');
                        }, 2000);
                    } else if (index == 4) {
                        //顶部花
						$('#edit_area799059').show().addClass('element-box');
                        ...
                        //顶部花
						$('#edit_area28759').show().addClass('element-box');
                        ...
                        //顶部花
						$('#edit_area287590').show().addClass('element-box');
                        ...
                        //顶部花
						$('#edit_area2875909').show().addClass('element-box');
                        ...
                        //顶部花加载
						$('#edit_area2875909ac').show().addClass('element-box');
                        ...
                        //顶部花加载
						$('#edit_area267571').show().addClass('element-box');
                        ...
                        //顶部花加载
						$('#edit_area2675712a').show().addClass('element-box');
                        ...
                        //顶部花
						$('#edit_area2675712bb').show().addClass('element-box');
